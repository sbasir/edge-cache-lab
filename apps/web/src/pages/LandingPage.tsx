			...
			<div className="hero-section">
				<div className="container">
					<div className="hero-content">
						...
						<p className="hero-subtitle">Experience Production-Grade CDN Caching in Action</p>
					...
					<div className="info-steps">
						<div className="info-step">
							...
							<div className="step-content">
								<h4>First Request</h4>
								<p>
									Visit a product page - you'll see <strong>X-Cache: MISS</strong> as content is
						...
						<div className="info-step">
							...
							<div className="step-content">
								<h4>Cache Hit</h4>
								<p>
									Refresh the page - now you see <strong>X-Cache: HIT</strong> as Varnish serves
									from cache
								</p>
							</div>
						</div>
						<div className="info-step">
							...
							<div className="step-content">
								<h4>Cache Bypass</h4>
								<p>
									Visit Cart or Account - these show <strong>X-Cache: PASS</strong> and never cache
								</p>
							</div>
						</div>
						<div className="info-step">
