...
export default function AdminPage() {
	...
	const handleUpdate = async () => {
		try {
			...
			const response = await fetchNoStore(`${OpenAPI.BASE}/admin/product/${productId}`, {
				method: 'POST',
				headers: {
	...
	const handlePurge = async () => {
		try {
			...
			const response = await fetchNoStore(`${OpenAPI.BASE}/product/${productId}`, {
				method: 'PURGE',
				headers: {
					'X-Purge-Token': purgeToken
				}
				...
				<div className="content-section">
					<div className="admin-form">
						...
						<p className="form-hint">
							Updates are in-memory for demo purposes and will reset on API restart.
						</p>
						...
						<div className="form-group">
							...
							/>
							<p className="form-hint">
								Required for both update and PURGE. The Varnish demo does not accept X-Purge-Tags as
								a token.
							</p>
						</div>
